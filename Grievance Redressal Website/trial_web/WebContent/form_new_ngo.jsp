...
<div class="row">
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="bootstrap-form-with-validation" action="form_new_ngo">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control input-lg" rows="2" wrap="hard" name="ngo_name" placeholder="Choose NGO Name" id="textarea-input"></textarea>
                </div>
                <div class="form-group">
                    <!--<label class="control-label" for="textarea-input">Enter Complain</label>-->
                    <textarea class="form-control input-lg" rows="5" wrap="hard" name="ngo_mission" placeholder="Choose NGO Mission" id="textarea-input"></textarea>
                </div>
                <div class="form-group">

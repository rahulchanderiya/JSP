...
<div class="row">
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="bootstrap-form-with-validation" action="join_new_ngo">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control input-lg" rows="2" wrap="hard" name="ngo_name" placeholder="Enter NGO Name you Wish to Join" id="textarea-input"></textarea>
                </div>
                <div class="form-group">

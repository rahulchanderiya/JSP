...
<div class="row">
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="bootstrap-form-with-validation" action="give_feedback">
                ...
                <div class="form-group">
                    <!--<label class="control-label" for="textarea-input">Enter Complain</label>-->
                    <textarea class="form-control input-lg" rows="5" wrap="hard" name="feedback" placeholder="Enter Your Feedback" id="textarea-input"></textarea>
                </div>
                <div class="form-group">

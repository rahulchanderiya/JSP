...
<div class="row">
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="bootstrap-form-with-validation" action="file_complain">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control input-lg" rows="5" wrap="hard" name="complain" placeholder="Enter Your Complain" id="textarea-input"></textarea>
                </div>
                <div class="form-group">

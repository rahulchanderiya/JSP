...
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			...
			<li><a href="#">Delete Complain</a></li>
		</ol>
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="bootstrap-form-with-validation" action="delete_complain">
                <h2 class="text-center text-primary"><strong><span style="text-decoration: underline;">Delete Complaint Record</span></strong> </h2>
                <br>
                <br>
                <div class="form-group"></div>
                <div class="form-group">
                    <!--<label class="control-label" for="textarea-input">Enter Complain</label>-->
                    <textarea class="form-control input-lg" rows="2" wrap="hard" name="complain_no" placeholder="Complain No." id="textarea-input"></textarea>
                </div>
                <div class="form-group">
                    <button class="btn btn-success btn-lg" type="submit">Delete</button>
                </div>
            </form>
        </div>
    </div>
